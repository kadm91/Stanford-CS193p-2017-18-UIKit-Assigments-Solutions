            ...
            func matchSetRules(attribute1: String, attribute2: String, attribute3: String) -> Bool {
                if attribute1 == attribute2 && attribute2 == attribute3 {
                    ...
                    return false
                       ...
                       let evaluateSymbol = matchSetRules(attribute1: card1.symbol.rawValue, attribute2: card2.symbol.rawValue, attribute3: card3.symbol.rawValue)
                       let evaluateShadding = matchSetRules(attribute1: card1.symbolshadding.rawValue, attribute2: card2.symbolshadding.rawValue, attribute3: card3.symbolshadding.rawValue)
                       let evaluteNumber = matchSetRules(attribute1: card1.numberOfSymbols.rawValue, attribute2: card2.numberOfSymbols.rawValue, attribute3: card3.numberOfSymbols.rawValue)
                       let evaluateColor =  matchSetRules(attribute1: card1.symbolColor.rawValue, attribute2: card2.symbolColor.rawValue, attribute3: card3.symbolColor.rawValue)
